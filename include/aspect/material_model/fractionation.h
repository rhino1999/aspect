...
#ifndef _aspect_material_model_fractionation_h
#define _aspect_material_model_fractionation_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class Fractionation : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
      ...
      private:
        ...
        double chemical_diffusivity;
        double diffusion_temperature_depenence;
    };
