...
#ifndef _aspect_material_model_steinberger_reaction_h
#define _aspect_material_model_steinberger_reaction_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class SteinbergerReaction: public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
      ...
      private:
        ...
        /**
         * Reaction depth, above which composition changes.
         */
