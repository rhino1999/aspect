...
#ifndef _aspect_material_model_drucker_prager_seed_h
#define _aspect_material_model_drucker_prager_seed_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class DruckerPragerSeed : public MaterialModel::Interface<dim>, public ::aspect::SimulatorAccess<dim>
    {
      public:
        /**
