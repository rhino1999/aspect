...
#ifndef _aspect_particle_property_post_melt_sta_h
#define _aspect_particle_property_post_melt_sta_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Property
    {
       ...
       */
      template <int dim>
      class PostMeltSta : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
      {
        public:
          /**
           * Constructor.
        ...
        private:
           ...
           */
          std::unique_ptr<MaterialModel::ReactionModel::PostMeltSta<dim>> post_melt_sta;
      };
    }
  }
}
