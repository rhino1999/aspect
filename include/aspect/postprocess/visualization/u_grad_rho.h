...
#ifndef _aspect_postprocess_visualization_u_grad_rho_h
#define _aspect_postprocess_visualization_u_grad_rho_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       * vector and computes a variable that represents the error of the
       * mass conservation equation div(rho*u). Note that in practice this
       * postprocessor computes the error of the equation
       * u*grad(rho) + rho*div(u).
       *
