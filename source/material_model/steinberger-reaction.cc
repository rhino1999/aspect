...
#include <aspect/material_model/steinberger_reaction.h>
...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    template <int dim>
    void
    SteinbergerReaction<dim>::initialize()
    {
    ...
    template <int dim>
    void
    SteinbergerReaction<dim>::evaluate(const MaterialModel::MaterialModelInputs<dim> &in,
    ...
    template <int dim>
    void
    SteinbergerReaction<dim>::declare_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Material model");
      {
        prm.enter_subsection("Steinberger reaction");
        {
    ...
    template <int dim>
    void
    SteinbergerReaction<dim>::parse_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Material model");
      {
        prm.enter_subsection("Steinberger reaction");
    ...
    template <int dim>
    void
    SteinbergerReaction<dim>::create_additional_named_outputs (MaterialModel::MaterialModelOutputs<dim> &out) const
    {
...
namespace aspect
{
  namespace MaterialModel
  {
    ASPECT_REGISTER_MATERIAL_MODEL(SteinbergerReaction,
                                   "Steinberger reaction",
