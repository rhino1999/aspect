...
#ifndef _aspect_material_model_binary_solid_solution_h
#define _aspect_material_model_binary_solid_solution_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class BinarySolidSolution : public MaterialModel::MeltInterface<dim>, public ::aspect::SimulatorAccess<dim>, public MaterialModel::MeltFractionModel<dim>
    {
      public:
        /**
