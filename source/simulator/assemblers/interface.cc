    ...
    namespace Assembly
    {
      namespace Scratch
      {
        ...
        AdvectionSystem (const FiniteElement<dim> &finite_element,
          ...
          current_temperature_gradients(quadrature.size(), numbers::signaling_nan<Tensor<1,dim> >()),
          face_current_temperature_gradients(face_quadrature.size(), numbers::signaling_nan<Tensor<1,dim> >()),
        ...
        AdvectionSystem (const AdvectionSystem &scratch)
          ...
          current_temperature_gradients(scratch.current_temperature_gradients),
          face_current_temperature_gradients(scratch.face_current_temperature_gradients),
