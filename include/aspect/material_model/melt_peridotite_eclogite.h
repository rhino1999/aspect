...
#ifndef _aspect_material_model_melt_peridotite_eclogite_h
#define _aspect_material_model_melt_peridotite_eclogite_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class MeltPeridotiteEclogite : public MaterialModel::DiffusionDislocation<dim>, public MaterialModel::MeltFractionModel<dim>
    {
      public:
        /**
      ...
      private:
        ...
        double lithosphere_density_change;
        double reference_T;
        double eta_0;
        double xi_0;
        double eta_f;
